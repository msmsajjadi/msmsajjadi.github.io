...
Mehdi is a Research Scientist, Tech Lead & Manager at [Google DeepMind](https://deepmind.google/), where his work focuses on spatio-temporal scene understanding and deep generative models. Recently, he led the project that won the [Best Paper Award at CVPR 2026](https://d4rt-paper.github.io/). With over a decade of experience in the field, he is passionate about building systems that can perceive and generate the world in 3D. Previously, he completed his PhD at the [Max Planck Institute for Intelligent Systems](https://is.mpg.de/) with [Bernhard Schölkopf](https://is.mpg.de/~bs), supported by a fellowship from [ETH Zürich CLS](https://learning-systems.org/).
...
- <a href="https://arxiv.org/abs/2412.14294" target="_blank" rel="noopener noreferrer">TRecViT: A Recurrent Video Transformer</a> (TMLR 2026)
